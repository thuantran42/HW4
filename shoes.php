...
<body>
    ...
    case 'Add':
    $sqlAdd = "insert into RPGClothes (shoe_name) value (?)";
    ...
    break;
    case 'Edit':
    $sqlEdit = "update RPGClothes set shoe_name=? where shoe_id=?";
    ...
    break;
    case 'Delete':
    $sqlDelete = "delete from RPGClothes where shoe_id=?";
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$row["shoe_name"]?></td>
                <td>
                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#editClothes<?=$row[" shoe_id"]?>
                        ">
                        Edit
                    </button>
                    <div class="modal fade" id="editClothes<?=$row[" shoe_id"]?>
                        " data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editClothes<?=$row["shoe_id"]?>Label" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="editClothes<?=$row[" shoe_id"]?>Label">Edit shoe</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form method="post" action="">
                                        <div class="mb-3">
                                            <label for="editClothes<?=$row[" shoe_id"]?>Name" class="form-label">Name</label>
                                            <input type="text" class="form-control" id="editClothes<?=$row[" shoe_id"]?>Name" aria-describedby="editClothes<?=$row["shoe_id"]?>Help" name="iName" value="<?=$row['shoe_name']?>">
                                            <div id="editClothes<?=$row[" shoe_id"]?>Help" class="form-text">Enter the shoe's name.</div>
                                        </div>
