...
$sql = "SELECT rpg_id, rpgName, rpgElement, rpgClass from RPGCharacter";
...
?>
    ...
    <a class="btn btn-primary" href="character-add.php" role="button">Add a character</a>
    <a class="btn btn-primary" href="character-delete-save.php" role="button">Delete a character</a>
